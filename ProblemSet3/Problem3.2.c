...
// Function to calculate frequency from MIDI note
double midi_to_frequency(int note) {
    return 440.0 * pow(2.0, (note - 69) / 12.0);
}

// Function to print chord frequencies
...
int main() {
    ...
    // Prompt the user to enter the MIDI notes of the chord (separated by spaces)
